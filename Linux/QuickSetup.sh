...
sudo apt install -y zip curl tree python3-full python3-pip plocate snapd python3-venv tmux git-all htop uuid-runtime || { echo 'Failed to install packages'; exit 1; }
