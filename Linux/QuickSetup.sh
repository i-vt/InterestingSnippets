...
sudo apt install -y zip curl tree python3-full python3-pip plocate snapd python3-venv tmux git-all htop uuid-runtime build-essential net-tools ffmpeg rsync || { echo 'Failed to install packages'; exit 1; }
